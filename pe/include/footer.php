                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4">
                                    <div class="single-footer">
                                        ...
                                        <ul class="footer-menu">
                                            <li>
                                                <a href="../profile.php?p=1" target="_blank"><i class="zmdi zmdi-circle"></i><span>Mon profile</span></a>
                                            </li>
                                            <li>
                                                <a href="../login.php" target="_blank"><i class="zmdi zmdi-circle"></i><span>Connexion</span></a>
                                            </li>
                                            <li>
                                                <a href="panier.php?p=1"><i class="zmdi zmdi-circle"></i><span>Ma carte</span></a>
                                            </li>
                                            <li>
                                                <a href="panier.php?p=2"><i class="zmdi zmdi-circle"></i><span>List de souhaits</span></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
