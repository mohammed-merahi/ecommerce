<?php
    ...
    $banner           = $xml->xpath( '/parametres/affichage/boutique/banner' )[0];
                                ...
                                <div class="shop-option box-shadow mb-30 clearfix">
                                    ...
                                    <div class="short-by f-left text-center">
                                        ...
                                        <select id="sort" onchange="sort(<?php echo $articlesPage; ?>, '<?php echo $fam; ?>', '<?php echo $categ; ?>')">
                                            <option value="-">-----------------</option>
                                            <option value="0" <?php if(isset($_GET['sort'])) if($_GET['sort']==0) echo 'selected'; ?>>Nouveaux articles</option>
                                            <option value="1" <?php if(isset($_GET['sort'])) if($_GET['sort']==1) echo 'selected'; ?>>Prix Croissant</option>
                                            <option value="2" <?php if(isset($_GET['sort'])) if($_GET['sort']==2) echo 'selected'; ?>>Prix décroissant</option>
                                        </select>
                                    </div>
                                    <!-- showing -->
                                    ...
                                    <?php if( $grille == 'Oui' ){ ?>
                                        <div role="tabpanel" class="tab-pane<?php if($tab==0){echo 'active';$tab++;}else{echo '';} ?>" id="grid-view">
                                            ...
                                            <?php
                                                ...
                                                if( isset( $_GET['categ'] ) ){
                                                    $query .= " AND articles.categorie='" . mysql_real_escape_string( $_GET['categ'] ) . "' ";
                                                }else if( isset( $_GET['fam'] ) ){
                                                    $query .= " AND articles.famille='" . mysql_real_escape_string( $_GET['fam'] ) . "' ";
                                                }
