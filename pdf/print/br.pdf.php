...
/*****************************************************************************************/
		...
		$query = "SELECT codeart, designation, qte, prix_org FROM achats WHERE num_piece='$code' AND piece='BR' ";
		...
		while( $row = mysql_fetch_assoc($rows) ){
            ...
            //totaux
            $this->SetFillColor(255,255,255);
            $query = "SELECT    brs.date as brs_date,
                                ...
                                taxe_supp
                            FROM brs 
                            LEFT JOIN fournisseurs ON brs.codefour=fournisseurs.codefour 
                            WHERE brs.code='$code' ";
            $rows = mysql_query($query);
            ...
            while( $row = mysql_fetch_assoc($rows) ){
                ...
                $query = "SELECT    reglements_pieces.id,
                            ...
                            FROM brs 		
                            LEFT JOIN reglements_pieces ON brs.code=reglements_pieces.num_piece
                            LEFT JOIN reglements        ON reglements.code=reglements_pieces.num_reg
                            WHERE brs.code='$code' 
                                AND reglements_pieces.piece='BR'";
                $rows = mysql_query($query);
                ...
                $this->Cell($w[4], 8, "Arrêter le présent bon de réception à la somme de : ", '', 0, 'L', $fill);
...
$html = "<br><br><br><br><table><tr><td></td><td><b>Bon de réception N° " . $code . "</b></td><td>" . "</td></tr></table><br><br><br><br>";
