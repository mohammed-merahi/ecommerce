...
/*****************************************************************************************/
		...
		$query = "SELECT codeart, designation, qte, prix_org FROM ventes WHERE num_piece='$code' AND piece='CT' ";
		...
		while( $row = mysql_fetch_assoc($rows) ){
            ...
            //totaux
            $this->SetFillColor(255,255,255);
            $query = "SELECT    cts.date as cts_date,
                                ...
                                taxe_supp
                            FROM cts 
                            LEFT JOIN clients ON cts.codeclient=clients.codeclient 
                            WHERE cts.code='$code'  ";
            ...
            while( $row = mysql_fetch_assoc($rows) ){
                ...
                $query = "SELECT    reglements_pieces.id,
                            ...
                            FROM cts 		
                            LEFT JOIN reglements_pieces ON cts.code=reglements_pieces.num_piece
                            LEFT JOIN reglements        ON reglements.code=reglements_pieces.num_reg
                            WHERE cts.code='$code' 
                                AND reglements_pieces.piece='CT'";
                $rows = mysql_query($query);
                ...
                $this->Cell($w[4], 8, "Arrêter le présent bon de comptoir à la somme de : ", '', 0, 'L', $fill);
...
$html = "<br><br><br><br><table><tr><td></td><td><b>Bon de comptoir N° " . $code . "</b></td><td>" . "</td></tr></table><br><br><br><br>";
