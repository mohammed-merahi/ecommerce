...
/*****************************************************************************************/
		...
		$query = "SELECT codeart, designation, qte, prix_org FROM cmds_fours WHERE num_piece='$code' ";
		...
		while( $row = mysql_fetch_assoc($rows) ){
            ...
            //totaux
            $this->SetFillColor(255,255,255);
            $query = "SELECT    bcs.date as bcs_date,
                                ...
                                taxe_supp
                            FROM bcs 
                            LEFT JOIN fournisseurs ON bcs.codefour=fournisseurs.codefour 
                            WHERE bcs.code='$code' ";
            $rows = mysql_query($query);
            ...
            while( $row = mysql_fetch_assoc($rows) ){
                ...
                $query = "SELECT    reglements_pieces.id,
                            ...
                            FROM bcs 		
                            LEFT JOIN reglements_pieces ON bcs.code=reglements_pieces.num_piece
                            LEFT JOIN reglements        ON reglements.code=reglements_pieces.num_reg
                            WHERE bcs.code='$code' 
                                AND reglements_pieces.piece='BC'";
                $rows = mysql_query($query);
                ...
                $this->Cell($w[4], 8, "Arrêter le présent bon de commande à la somme de : ", '', 0, 'L', $fill);
...
$html = "<br><br><br><br><table><tr><td></td><td><b>Bon de commande N° " . $code . "</b></td><td>" . "</td></tr></table><br><br><br><br>";
