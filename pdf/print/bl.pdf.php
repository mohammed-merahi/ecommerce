...
/*****************************************************************************************/
        ...
        $query = "SELECT codeart, designation, qte, prix_org FROM ventes WHERE num_piece='$code' AND piece='BL' ";
		...
		while( $row = mysql_fetch_assoc($rows) ){
            ...
            //totaux
            $this->SetFillColor(255,255,255);
            $query = "SELECT    bls.date as bls_date,
                                ...
                                taxe_supp
                        FROM bls 
                        LEFT JOIN clients ON bls.codeclient=clients.codeclient 
                        WHERE bls.code='$code' ";
            ...
            while( $row = mysql_fetch_assoc($rows) ){
                ...
                $query = "SELECT    reglements_pieces.id,
                            ...
                            FROM bls 		
                            LEFT JOIN reglements_pieces ON bls.code=reglements_pieces.num_piece
                            LEFT JOIN reglements        ON reglements.code=reglements_pieces.num_reg
                            WHERE bls.code='$code' 
                                AND reglements_pieces.piece='BL'";
                $rows = mysql_query($query);
                ...
                $this->Cell($w[4], 8, "Arrêter le présent bon de livraison à la somme de : ", '', 0, 'L', $fill);
...
$html = "<br><br><br><br><table><tr><td></td><td><b>Bon de livraison N° " . $code . "</b></td><td>" . "</td></tr></table><br><br><br><br>";
