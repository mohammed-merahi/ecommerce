...
/*****************************************************************************************/
		...
		$query = "SELECT codeart, designation, qte, prix_org FROM achats WHERE num_piece='$code' AND piece='FF' ";
		...
		while( $row = mysql_fetch_assoc($rows) ){
            ...
            //totaux
            $this->SetFillColor(255,255,255);
            $query = "SELECT    ffs.date as ffs_date,
                                ...
                                taxe_supp
                            FROM ffs 
                            LEFT JOIN fournisseurs ON ffs.codefour=fournisseurs.codefour 
                            WHERE ffs.code='$code' ";
            $rows = mysql_query($query);
            ...
            while( $row = mysql_fetch_assoc($rows) ){
                ...
                $query = "SELECT    reglements_pieces.id,
                            ...
                            FROM ffs 		
                            LEFT JOIN reglements_pieces ON ffs.code=reglements_pieces.num_piece
                            LEFT JOIN reglements        ON reglements.code=reglements_pieces.num_reg
                            WHERE ffs.code='$code' 
                                AND reglements_pieces.piece='FF'";
                $rows = mysql_query($query);
                ...
                $this->Cell($w[4], 8, "Arrêter la présente facture d'achat à la somme de : ", '', 0, 'L', $fill);
...
$html = "<br><br><br><br><table><tr><td></td><td><b>Facture d'achat N° " . $code . "</b></td><td>" . "</td></tr></table><br><br><br><br>";
